...
class SortingRobot:
    ...
    def __str__(self):
        return f"I'm currently holding the item {self._item} and I'm at position {self._position}!"
    ...
    def sort(self):
        ...
        #     for position in range(len(self._list) - k - 1):
        #         if self._list[position] > self._list[position + 1]:
        #             self._list[position], self._list[position +
        #                                              1] = self._list[position + 1], self._list[position]
        # return self._list
